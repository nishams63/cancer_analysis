...
export const trend = [{ m: "Jan", ctDNA: 24, CEA: 15, TumorVolume: 18 }, { m: "Feb", ctDNA: 29, CEA: 17, TumorVolume: 19 }, { m: "Mar", ctDNA: 37, CEA: 18, TumorVolume: 20 }, { m: "Apr", ctDNA: 68, CEA: 21, TumorVolume: 22 }, { m: "May", ctDNA: 72, CEA: 24, TumorVolume: 24 }, { m: "Jun", ctDNA: 81, CEA: 27, TumorVolume: 27 }];
